...
class BasicEncoder(nn.Module):
    def __init__(self, input_dim=2, output_dim=32, stride=1):
        ...
        # self.tail = nn.Conv2d(output_dim, 1, kernel_size=1)
...
class Attention(nn.Module):
    def __init__(self, query_dim, context_dim=None, num_heads=8, dim_head=8, qkv_bias=False):
        super().__init__()
